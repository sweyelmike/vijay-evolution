      ...
      <motion.div className="hero-content" variants={container} initial="hidden" animate="visible">
        <motion.div className="left" variants={item}>
          ...
          <motion.p className="st-desc" variants={item}>
            An entertainer who connected with millions through cinema.
Stories, emotion, and mass appeal built a bond with people on screen.
          </motion.p>
        ...
        <motion.div className="right" variants={item}>
          <h1 className="st-title">TVK VIJAY</h1>
          <motion.p className="st-text" variants={item}>
            Stepping beyond the screen to serve people directly.
The connection remains, now strengthened by responsibility and purpose.
          </motion.p>
        </motion.div>
      </motion.div>
